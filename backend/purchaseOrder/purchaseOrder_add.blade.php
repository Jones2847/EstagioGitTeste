...
@section('admin')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col md-1">
                                    <div class="md-3">
                                        ...
                                        <input id="pONumber" name="pONumber" class="form-control example-date-input" type="text" value="{{$purchaseOrderNo}}"readonly style="background-color: #ddd">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="post" id="formsupdet" action="{{route('purchaseOrder.store')}}">
                                @csrf
                                ...
                                <table class="table-sm table-bordered" width="100%"style="border-color: #ddd">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="discountValue" value="0" id="discountValue"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <textarea name="Observations" class="form-control" id="pOObservation" placeholder="Write here purchase Order observations..."></textarea>
                                    </div>
                                </div><br>
    ...
    <script id="document-template" type="text/x-handlebars-template">
        ...
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td>
                ...
                <input type="hidden" name="ProductUnit[]" value="@{{product_unit}}">{{$products[0]->product_unit}}
            </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on("keyup click", "#discountValue", function () {
